...
const content = [
  ...
  ['pmain', 'All triangles are made of three points (called <b>vertices</b>), and the lines connecting them. Now imagine three random non-collinear points (non-collinear means that all three points are not in a straight line). Call these three points \\(P_1\\), \\(P_2\\) and \\(P_3\\):'], 
  ['displayimg', 't1.png'], 
