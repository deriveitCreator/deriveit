...
const content = [
  ...
  ['pmain', 'Consider this triangle \\(ABC\\), where \\(AC > AB\\). The angles opposite these two sides are \\(\\angle ABC\\) and \\(\\angle ACB\\):'], 
  ...
  ['pmain', 'Consider this triangle \\(ABC\\), where \\(\\angle ABC \\gt \\angle ACB\\). The sides opposite these two angles are \\(AC\\) and \\(AB\\):'], 
  ['displayimg', 'angleSideOppBiggest1.png'], 
