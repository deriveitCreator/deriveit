...
const content = [
  ...
  ['displayimg', 'r7.png'],
  ['pmain', 'The ellipse is the locus of all points where the sum of the distances between a point and the two focii is always \\(2a\\). This means for a point inside the ellipse, the sum of the distances between that point and the two focii is always \\(\\lt 2a\\). For a point outside the ellipse, the sum of the distances between that point and two focii is always \\(\\gt 2a\\). Now let\'s say that the line \\(\\Vert F_2 \\ F_1^*\\Vert\\) intersect at point \\(B\\) where \\(B\\) lies on the tangent line:'],
  ['displayimg', 'r8.png'],
  ['pmain', 'Since \\(B\\) is outside the ellipse:'],
  ["displayFormula","\\[ \\begin{align} &\\Vert F_2 \\ F_1^* \\Vert \\gt 2a \\\\ \\therefore &\\Vert F_2 \\ F_1^* \\Vert \\gt \\Vert F_2 \\ A \\Vert + \\Vert A \\ F_1 \\Vert \\end{align} \\]"],
