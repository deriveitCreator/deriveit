...
const content = [
  ...
  ['pmain', 'We can use the definition of dot product to find \\(\\operatorname{sign}(\\cos(\\theta))\\):'], 
  ['displayFormula', '$$ \\cos(\\theta) = \\frac{\\textbf{v} \\cdot \\textbf{u}}{\\Vert\\textbf{v}\\Vert \\ \\Vert\\textbf{u}\\Vert}  \\implies \\operatorname{sign}(\\cos(\\theta)) = \\frac{ \\frac{\\textbf{v} \\cdot \\textbf{u}}{\\Vert\\textbf{v}\\Vert \\ \\Vert\\textbf{u}\\Vert}}{ \\frac{| \\textbf{v} \\cdot \\textbf{u} |}{\\Vert\\textbf{v}\\Vert \\ \\Vert\\textbf{u}\\Vert}  } = \\frac{\\textbf{v} \\cdot \\textbf{u}}{| \\textbf{v} \\cdot \\textbf{u} |}$$'],
  ['pmain', 'This means:'], 
