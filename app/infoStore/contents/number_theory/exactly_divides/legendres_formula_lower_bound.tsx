...
const content = [
  ...
  ['pmain','The notation [\\(p^e \\| n!\\)] means \\(p\\) divides \\(n!\\) exactly \\(e\\) times (i.e. \\(p^e \\mid n!\\) but \\(p^{e+1} \\nmid n!\\)). This gives a lower bound:'],
  ...
  ['displayFormula','$$e \\le \\frac{ \\frac{n}{p} ( 0 - 1 ) }{\\frac{1}{p} - 1 }$$'],
  ['pmain','We can simplify this to:'],
  ['displayFormula','$$e \\le \\frac{ n }{p - 1 }$$'],
];
