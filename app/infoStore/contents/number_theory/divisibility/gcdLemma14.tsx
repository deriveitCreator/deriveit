...
const content = [
  ...
  ['pmain', 'Therefore \\(a_2a_1|b\\). We can generalize this, let\'s say if \\(a_3|b\\) and all \\(a_i\\) are pairwise relatively prime. If \\((a_1,a_3)=1\\) and \\((a_2,a_3)=1\\), then \\((a_1a_2,a_3)=1\\). If \\(a_1a_2|b\\), \\(a_3|b\\) and \\((a_1a_2,a_3)=1\\), then \\(a_1a_2a_3|b\\), by the reasoning stated above.'],
];
