...
const content = [
  ...
  ['pmain', 'This means if \\((a-b) | a(a^k - b^k)\\) and \\((a-b) | b^k (a-b)\\), then \\((a-b)|(a^{k+1} - b^{k+1})\\). This proves that \\((a-b)|(a^n - b^n)\\) when \\(n \\gt 1\\). Now let\'s talk about the next case where \\(m \\gt 1\\), \\(n \\gt 1\\) and \\(m|n\\). Let \\(mk=n\\), then:'],
