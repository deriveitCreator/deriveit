...
const content = [
  ...
  ['displayFormula', '$$\\begin{gather} x ≡ b_1 \\bmod n_1\\\\ x ≡ b_2 \\bmod n_2 \\\\ \\vdots \\\\ x ≡ b_k \\bmod n_k \\end{gather}$$'],
  ...
  ['pmain', '\\(N_3\\) is the multiplication of all \\(n_i\\) except \\(n_3\\). Since \\((n_1, n_3)=1\\) and \\((n_2, n_3)=1\\), then \\((n_1n_2, n_3)=1\\) using <a href="../divisibility_and_gcd/multiplicative">this lemma</a>. This way we can also derive \\((n_1n_2n_4, n_3)=1\\), and we can further say \\((N_3,n_3)=1\\). By similar reasoning, we can say the same for any \\(N_i\\):'],
  ['displayFormula', '$$ (N_i, n_i) = 1 $$'],
  ['pmain', 'Using <a href="../modular_arithmetic/modular_inverse">this lemma</a>, we can conclude there exists an inverse:'],
  ['displayFormula', '$$ N_iN_i^{-1} ≡ 1 \\mod n_i $$'],
  ['pmain', 'Since \\(b_i ≡ b_i \\bmod n_i\\):'],
  ['displayFormula', '$$ N_iN_i^{-1} b_i ≡ b_i \\mod n_i $$'],
  ['pmain', 'Since \\(N_j\\) contains a factor of \\(n_i\\) where \\(i \\ne j\\), then:'],
  ['displayFormula', '$$N_jN_j^{-1}b_j ≡ 0 \\mod n_i $$'],
  ['pmain', 'This means:'],
  ['displayFormula', '$$ N_iN_i^{-1} b_i + N_jN_j^{-1}b_j ≡ b_i \\mod n_i $$'],
  ['pmain', 'Similarly:'],
  ['displayFormula', '$$ N_iN_i^{-1} b_i + N_jN_j^{-1}b_j ≡ b_j \\mod n_j $$'],
  ['pmain', 'Consider:'],
  ...
  ['pmain', 'This means:'],
  ['displayFormula', '$$\\begin{gather} A ≡ b_1 \\bmod n_1 \\\\ A ≡ b_2 \\bmod n_2 \\\\ \\vdots \\\\ A ≡ b_k \\bmod n_k \\end{gather}$$'],
