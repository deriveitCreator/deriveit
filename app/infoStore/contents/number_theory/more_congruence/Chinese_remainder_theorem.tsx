...
const content = [
  ...
  ['displayFormula', '$$\\begin{gather} x ≡ b_1 \\bmod n_1, \\quad x ≡ b_2 \\bmod n_2, \\\\ \\ldots, \\quad x ≡ b_k \\bmod n_k \\end{gather}$$'],
  ...
  ['pmain', 'Using <a href="https://www.deriveit.net/discrete_mathematics/modular_arithmetic/modular_inverse">this lemma</a>, we can conclude there exists an inverse:'],
  ...
  ['displayFormula', '$$\\begin{gather} N_jN_j^{-1} ≡ 0 \\mod n_i \\\\ N_jN_j^{-1}b_j ≡ 0 \\mod n_i \\end{gather}$$'],
  ['pmain', 'This means:'],
