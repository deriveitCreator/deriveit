export const title="Solution to x^2 ≡ -1 mod p";
const content = [
  ['h1', 'Solution To x<sup>2</sup> ≡ -1 mod p'],
  ...
  ['pmain', 'The second half is the same size as the first. Since \\(p=4k+1\\), then \\(\\frac{p-1}{2} = 2k\\), which means:'],
  ...
  ['pmain', 'Thus, \\(x^2 ≡ -1 \\bmod p\\) has the solution \\(x = ((p - 1)/2)!\\) when \\(p ≡ 1 \\bmod 4\\).'],
   /*['pmain', 'There is no solution for \\(x\\) when \\(p ≡ 3 \\bmod 4\\).'] INCOMPLETE */
];
