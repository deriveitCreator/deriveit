...
const content = [
  ...
  ['pmain', 'According to <a href="../divisibility/divisibility1">this lemma</a>, \\(d\\) can divide any linear combination of \\((a+b)\\) and \\((a-b)\\):'], 
  ...
  ['displayFormula', '$$ d|2(a,b) $$'],
  ['pmain', 'Since \\((a,b)=1\\), then \\(d|2\\). This means \\(d\\) can only be 2 or 1.'],
];
