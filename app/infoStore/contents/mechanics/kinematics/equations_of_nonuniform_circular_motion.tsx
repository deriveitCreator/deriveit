...
const content = [
  ...
  ['pmain', 'Let \\(\\omega\\) be the angular speed. Let \\(d \\theta\\) be the instantaneous change in radians:'], 
  ['displayFormula', '\\[\\omega = \\frac{d \\theta}{d t}\\]'],
  ['pmain', 'Since the speed \\(v\\) can be defined as the instantaneous change in arc length over time, and since \\(d(\\text{arc length}) = d\\theta \\ r\\):'], 
  ['displayFormula', '\\[v = \\frac{d (\\text{arc length})}{d t} = \\frac{d \\theta \\ r}{d t} = \\omega \\ r\\]'],
  ['pmain', 'Which means:'], 
  ['displayFormula', '\\[a_c = \\frac{v^2}{r} = \\frac{( \\omega \\ r)^2}{r} = \\omega ^2 r \\]'],
