...
const content = [
  ...
  ['pmain', 'According to <a href="https://www.deriveit.net/discrete_mathematics/divisibility/divisibility1">this lemma</a>, \\(d\\) can divide any linear combination of \\((a+b)\\) and \\((a-b)\\):'], 
  ...
  ['pmain', 'According to <a href="https://www.deriveit.net/discrete_mathematics/more_gcd/gcdLemma15">this lemma</a>, we can take the 2 out:'], 
