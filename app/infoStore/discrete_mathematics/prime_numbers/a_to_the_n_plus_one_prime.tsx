...
const content = [
  ...
  ['pmain','Now suppose \\(n\\) is not a power of 2. If \\(n \\ne 2^k\\), then according to the Fundamental Theorem of Arithmetic, there must be an odd prime (let\'s call it \\(s\\)) that divides \\(n\\), so \\(n = rs\\) for some integer \\(r\\). Also, according to <a href="www.deriveit.net/discrete_mathematics/divisibility/divisibilityLemma1">this lemma</a>:'],
