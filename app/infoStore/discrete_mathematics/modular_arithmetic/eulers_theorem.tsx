...
const content = [
  ...
  ['pmain', 'If (a, m) = 1 then \\(m|r_i - r_j\\) (using <a href="../divisibility_and_gcd/other">this lemma</a>), and:'],
  ['displayFormula', '$$ m|r_i - r_j ⇒ r_i ≡ r_j \\mod m $$'],
  ['pmain', 'which cannot happen unless i = j. This shows all \\(ar\\) are distinct, therefore \\(\\{ar_1 \\ldots ar_k \\}\\) is also a reduced residue system mod \\(m\\). If \\(\\gcd(r_1, m) = 1\\) and \\(\\gcd(r_2, m) = 1\\), then \\(\\gcd(r_1r_2, m) = 1\\) (<a href="../divisibility_and_gcd/multiplicative">click here</a> for proof), which means:'],
