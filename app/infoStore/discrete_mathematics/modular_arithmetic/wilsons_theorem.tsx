...
const content = [
  ...
  ['pmain', 'Every term in \\(\\{ 2,3,4, \\ldots , (p-3), (p-2) \\}\\) is coprime with \\(p\\), and since \\(p\\) is odd, there are even numbers in \\(\\{ 2,3, \\ldots , (p-2) \\}\\), which means each number in the set has an inverse that is also in the set, so we can pair each number with their inverse:'],
  ['displayFormula', '$$ \\begin{align} (2)(3) \\ldots (p-3)(p-2) &= (a_1a_1^-1)(a_2a_2^-1) \\dots (a_ka_k^-1) \\\\ &≡ 1 \\mod p \\end{align}$$'],
  ['pmain', 'This means:'],
