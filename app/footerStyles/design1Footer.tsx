...
export default function footerComp(){
    return <footer style={footerIdStyle}>
        ...
        <p className={cursiveMain.className} style={footerPStyle}>
            If you find a bug in this website or want to report an error, <Link href='/'>click here</Link><br/>
            If there are any equations for which you want proof for, <Link href='/'>click here</Link><br/>
            For any suggestion and ideas, <Link href='/'>click here</Link>
        </p>
